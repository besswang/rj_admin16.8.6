...
// 数据看版
export const LOOK_REQUEST_POSTS = 'LOOK_REQUEST_POSTS'
export const LOOK_RECEIVE_POSTS = 'LOOK_RECEIVE_POSTS'
export const LOOK_FAILURE_POSTS = 'LOOK_FAILURE_POSTS'
export const TAB_ADD = 'TAB_ADD'
export const TAB_REMOVE = 'TAB_REMOVE'
export const CHANGE_TAB_ACTIVE = 'CHANGE_TAB_ACTIVE'
export const SAVE_DAY_LIST = 'SAVE_DAY_LIST'
export const SELECT_STATE_TYPE = 'SELECT_STATE_TYPE'
export const AREA_REQUEST_POSTS = 'AREA_REQUEST_POSTS'
export const AREA_RECEIVE_POSTS = 'AREA_RECEIVE_POSTS'
export const AREA_FAILURE_POSTS = 'AREA_FAILURE_POSTS'
export const SAVE_LOAN_ROLE = 'SAVE_LOAN_ROLE'
// 报告
export const REPORT_REQUEST_POSTS = 'REPORT_REQUEST_POSTS'
export const REPORT_RECEIVE_POSTS = 'REPORT_RECEIVE_POSTS'
export const REPORT_FAILURE_POSTS = 'REPORT_FAILURE_POSTS'
